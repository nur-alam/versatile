...
class MaintenanceMode {
	...
	/**
	 * Tukitaki_update_maintenance_mood description.
	 *
	 * @return array description
	 */
	public function tukitaki_update_maintenance_mood() {
		try {
			$latest_info                             = get_option( 'tukitaki_default_mood_info', TUKITAKI_DEFAULT_MOOD_INFO );
			...
			$current_mood_info                       = get_option( 'tukitaki_default_mood_info', TUKITAKI_DEFAULT_MOOD_INFO );
			$current_mood_info['enable_maintenance'] = $params['enable_maintenance'] ?? false;
			if ( $current_mood_info['enable_maintenance'] ) {
				$current_mood_info['enable_coming_soon'] = false;
			}
			...
			update_option( 'tukitaki_default_mood_info', $current_mood_info );
			$latest_info = get_option( 'tukitaki_default_mood_info', TUKITAKI_DEFAULT_MOOD_INFO );
